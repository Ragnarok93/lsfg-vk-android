...
# Candidate B6 is an exact Mipmaps phase-0 private-register SSA cleanup. It is
# composed after B4 and before compilation; its exact input/output fingerprints
# make translator drift a safe no-op.
python3 "${REPO_ROOT}/scripts/apply-candidate-b6-mipmaps-phase0-ssa.py" --root "${REPO_ROOT}"
