...
VkResult layer_vkCreateDevice(
    ...
    try {
        ...
        // capability failure. Passing them through also avoids overwriting the
        // working presentation dispatch table from the game's real device.
...
void ovkDestroyDevice(VkDevice a, const VkAllocationCallbacks* b) { next_vkDestroyDevice(a, b); }
VkResult ovkSetDeviceLoaderData(VkDevice a, void* b) { return next_vSetDeviceLoaderData(a, b); }
PFN_vkVoidFunction ovkGetInstanceProcAddr(VkInstance a, const char* b) { return next_vkGetInstanceProcAddr(a, b); }
PFN_vkVoidFunction ovkGetDeviceProcAddr(VkDevice a, const char* b) { return next_vkGetDeviceProcAddr(a, b); }
...
VkResult ovkCreateSwapchainKHR(VkDevice a, const VkSwapchainCreateInfoKHR* b, const VkAllocationCallbacks* c, VkSwapchainKHR* d) { return next_vkCreateSwapchainKHR(a, b, c, d); }
VkResult ovkQueuePresentKHR(VkQueue a, const VkPresentInfoKHR* b) { return next_vkQueuePresentKHR(a, b); }
void ovkDestroySwapchainKHR(VkDevice a, VkSwapchainKHR b, const VkAllocationCallbacks* c) { next_vkDestroySwapchainKHR(a, b, c); }
VkResult ovkGetSwapchainImagesKHR(VkDevice a, VkSwapchainKHR b, uint32_t* c, VkImage* d) { return next_vkGetSwapchainImagesKHR(a, b, c, d); }
VkResult ovkAllocateCommandBuffers(VkDevice a, const VkCommandBufferAllocateInfo* b, VkCommandBuffer* c) { return next_vkAllocateCommandBuffers(a, b, c); }
void ovkFreeCommandBuffers(VkDevice a, VkCommandPool b, uint32_t c, const VkCommandBuffer* d) { next_vkFreeCommandBuffers(a, b, c, d); }
VkResult ovkBeginCommandBuffer(VkCommandBuffer a, const VkCommandBufferBeginInfo* b) { return next_vkBeginCommandBuffer(a, b); }
VkResult ovkEndCommandBuffer(VkCommandBuffer a) { return next_vkEndCommandBuffer(a); }
VkResult ovkCreateCommandPool(VkDevice a, const VkCommandPoolCreateInfo* b, const VkAllocationCallbacks* c, VkCommandPool* d) { return next_vkCreateCommandPool(a, b, c, d); }
void ovkDestroyCommandPool(VkDevice a, VkCommandPool b, const VkAllocationCallbacks* c) { next_vkDestroyCommandPool(a, b, c); }
VkResult ovkCreateImage(VkDevice a, const VkImageCreateInfo* b, const VkAllocationCallbacks* c, VkImage* d) { return next_vkCreateImage(a, b, c, d); }
void ovkDestroyImage(VkDevice a, VkImage b, const VkAllocationCallbacks* c) { next_vkDestroyImage(a, b, c); }
void ovkGetImageMemoryRequirements(VkDevice a, VkImage b, VkMemoryRequirements* c) { next_vkGetImageMemoryRequirements(a, b, c); }
VkResult ovkBindImageMemory(VkDevice a, VkImage b, VkDeviceMemory c, VkDeviceSize d) { return next_vkBindImageMemory(a, b, c, d); }
VkResult ovkAllocateMemory(VkDevice a, const VkMemoryAllocateInfo* b, const VkAllocationCallbacks* c, VkDeviceMemory* d) { return next_vkAllocateMemory(a, b, c, d); }
void ovkFreeMemory(VkDevice a, VkDeviceMemory b, const VkAllocationCallbacks* c) { next_vkFreeMemory(a, b, c); }
VkResult ovkCreateSemaphore(VkDevice a, const VkSemaphoreCreateInfo* b, const VkAllocationCallbacks* c, VkSemaphore* d) { return next_vkCreateSemaphore(a, b, c, d); }
void ovkDestroySemaphore(VkDevice a, VkSemaphore b, const VkAllocationCallbacks* c) { next_vkDestroySemaphore(a, b, c); }
VkResult ovkGetMemoryFdKHR(VkDevice a, const VkMemoryGetFdInfoKHR* b, int* c) { return next_vkGetMemoryFdKHR ? next_vkGetMemoryFdKHR(a, b, c) : VK_ERROR_EXTENSION_NOT_PRESENT; }
VkResult ovkGetSemaphoreFdKHR(VkDevice a, const VkSemaphoreGetFdInfoKHR* b, int* c) { return next_vkGetSemaphoreFdKHR ? next_vkGetSemaphoreFdKHR(a, b, c) : VK_ERROR_EXTENSION_NOT_PRESENT; }
VkResult ovkGetAndroidHardwareBufferPropertiesANDROID(VkDevice a, const AHardwareBuffer* b, VkAndroidHardwareBufferPropertiesANDROID* c) { return next_vkGetAndroidHardwareBufferPropertiesANDROID ? next_vkGetAndroidHardwareBufferPropertiesANDROID(a, b, c) : VK_ERROR_EXTENSION_NOT_PRESENT; }
void ovkGetDeviceQueue(VkDevice a, uint32_t b, uint32_t c, VkQueue* d) { next_vkGetDeviceQueue(a, b, c, d); }
VkResult ovkQueueSubmit(VkQueue a, uint32_t b, const VkSubmitInfo* c, VkFence d) { return next_vkQueueSubmit(a, b, c, d); }
void ovkCmdPipelineBarrier(VkCommandBuffer a, VkPipelineStageFlags b, VkPipelineStageFlags c, VkDependencyFlags d, uint32_t e, const VkMemoryBarrier* f, uint32_t g, const VkBufferMemoryBarrier* h, uint32_t i, const VkImageMemoryBarrier* j) { next_vkCmdPipelineBarrier(a, b, c, d, e, f, g, h, i, j); }
void ovkCmdBlitImage(VkCommandBuffer a, VkImage b, VkImageLayout c, VkImage d, VkImageLayout e, uint32_t f, const VkImageBlit* g, VkFilter h) { next_vkCmdBlitImage(a, b, c, d, e, f, g, h); }
VkResult ovkAcquireNextImageKHR(VkDevice a, VkSwapchainKHR b, uint64_t c, VkSemaphore d, VkFence e, uint32_t* f) { return next_vkAcquireNextImageKHR(a, b, c, d, e, f); }
} // namespace Layer
